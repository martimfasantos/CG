...
function createOrigami3(x, y, z, texture) {
    ...
    const uvs = new Float32Array([
        ...
        //NECK
        4.2, 4.2, 5.2, 1, 3.5, 3.5,
        4.2, 4.2, 3.5, 3.5, 5.2, 1,
        10.4, 10.4, 17.1, 5, 4.2, 4.2,
        10.4, 10.4, 4.2, 4.2, 17.1, 5,
        4.2, 4.2, 17.1, 5, 5.2, 1,
        4.2, 4.2, 5.2, 1, 17.1, 5,

        //BODY
        10.4, 10.4, 17.1, 5, 21, 8.7,
        17.1, 5, 21, 4.2, 21, 8.7,
        10.4, 10.4, 21, 4.2, 21, 8.7,
        10.4, 10.4, 17.1, 3.3, 21, 21,
        17.1, 3.3, 21, 13.9, 21, 21,
        17.1, 3.3, 21, 8.7, 21, 13.9,
        17.1, 3.3, 21, 4.2, 16.2, 16.2,
        10.4, 10.4, 17.1, 3.3, 16.2, 16.2,
        ...
        //NECK
        3.5, 3.5, 1, 5.2, 4.2, 4.2,
        4.2, 4.2, 3.3, 17.1, 10.4, 10.4,
        5.2, 1, 3.3, 17.1, 4.2, 4.2,
        3.5, 3.5, 4.2, 4.2, 1, 5.2,
        4.2, 4.2, 10.4, 10.4, 3.3, 17.1,
        5.2, 1, 4.2, 4.2, 3.3, 17.1,

        //BODY
        8.7, 21, 3.3, 17.1, 10.4, 10.4,
        8.7, 21, 4.2, 21, 3.3, 17.1,
        8.7, 21, 4.2, 21, 10.4, 10.4,
        21, 21, 3.3, 17.1, 10.4, 10.4,
        21, 21, 13.9, 21, 3.3, 17.1,
        8.7, 21, 3.3, 17.1, 13.9, 21,
        16.2, 16.2, 4.2, 21, 10.4, 10.4,
        16.2, 16.2, 3.3, 17.1, 10.4, 10.4,
